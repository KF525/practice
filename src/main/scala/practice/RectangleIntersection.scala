...
class RectangleIntersection {
  def findIntersection(rectangle1: Rectangle, rectangle2: Rectangle): Option[Rectangle] = {
    ...
    val newRectangleTopY =
      if (rectangle1.bottom_y + rectangle1.height < rectangle2.bottom_y + rectangle2.height) {
        rectangle1.bottom_y + rectangle1.height
      } else rectangle2.bottom_y + rectangle2.height

    val newRectangleRightX =
      if (rectangle1.left_x + rectangle1.width < rectangle2.left_x + rectangle2.width) {
        rectangle1.left_x + rectangle1.width
      } else rectangle2.left_x + rectangle2.width
    ...
    if (newHeight < 0 || newWidth < 0)
      ...
      Some(Rectangle(newLeftX, newBottomY, newWidth, newHeight))
  }
}
